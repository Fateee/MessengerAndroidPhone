...
//	public synchronized TreeMap<Integer, GroupChatMsgEntity> getChatMsgEntitiesToMap(String account) {
//		TreeMap<Integer, GroupChatMsgEntity> list = new TreeMap<Integer, GroupChatMsgEntity>();
//		Cursor cursor = mDb.query(mTableName, null, "groupId = ?",
//				new String[] { account + "" }, null, null, "mTime DESC");
//		if (cursor != null && cursor.getCount() > 0) {
//			while (cursor.moveToNext()) {
